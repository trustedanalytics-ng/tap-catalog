...
func (_m *MockEtcdKVStore) Set(key string, value interface{}, prevValue interface{}, prevIndex uint64) error {
	ret := _m.ctrl.Call(_m, "Set", key, value, prevValue, prevIndex)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockEtcdKVStoreRecorder) Set(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
